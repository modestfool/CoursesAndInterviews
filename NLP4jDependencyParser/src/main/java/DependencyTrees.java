...
/**
 * DependencyTrees.java
 * @author Basava R.Kanaparthi(basava.08@gmail.com)
 * Created on Mar 30, 2016
 */
    public class DependencyTrees {
        static public void main(String[] args) throws Exception {
            final String configFile = "edu/emory/mathcs/nlp/configuration/config-decode-en.xml";
            //final String inputFile  = "/Users/jdchoi/Documents/EmoryNLP/nlp4j/src/test/resources/dat/nlp4j.txt";
//            final InputStream configFile = DependencyTrees.class.getResourceAsStream("/configurations/config-decode-en.xml");
            final InputStream inputFile = DependencyTrees.class.getResourceAsStream("/input/input.txt");
            ...
            NLPDecoder nlp4j = new NLPDecoder(IOUtils.getInputStream(configFile));
