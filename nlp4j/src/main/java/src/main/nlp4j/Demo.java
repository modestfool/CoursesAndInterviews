...
public class Demo {
		static public void main(String[] args) throws Exception
		{
			...
			final InputStream configFile = Demo.class.getResourceAsStream("/configurations/config-decode-en.xml");
			final InputStream inputFile = Demo.class.getResourceAsStream("/input/input.txt");
			...
			NLPDecoder nlp4j = new NLPDecoder(configFile);
