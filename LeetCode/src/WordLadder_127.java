...
public class WordLadder_127 {
    ...
    static class WordNode{
        ...
        int level;
        WordNode parent;
        WordNode(String w, int l, WordNode parent)
        {
            word = w;
            level = l;
            this.parent = parent;
    ...
    public static int ladderLength(String beginWord, String endWord, Set<String>
            wordList)
    {
        ...
        while(!queue.isEmpty())
        {
            ...
            for (int i = 0; i < currArr.length; i++)
            {
                for(int j = 0; j < 26; j++)
                {
                    ...
                    {
                        WordNode newNode = new WordNode(newWord, curr.level +
                                1, curr);
                        queue.offer(newNode);
                    }
                    currArr[i] = c;
